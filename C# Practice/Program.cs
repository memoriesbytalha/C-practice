...
namespace MyApp
{
    internal class Program
    {
        ...
        //{
        //    // Call the MyMethod with a custom argument
        //    Panda.Panda.MyMethod("Panda");

        //    // Call the MyMethod with the default argument
        //    Panda.Panda.MyMethod();

        //    Helpers.MyMethod();

        //    int output = Panda.Panda.Mysum(5); 
        //    Console.WriteLine(output);


        //    string output2 = Panda.Panda.Names("Talha", "Ali");
    ...
    class car
    {
        ...
        static void Main(string[] args)
        {
            car myObj = new car(); //constructor -- New Object
